...
if ($request == 'GET') {
    ...
    if ((!isset($officename)) || (!isset($officeid))) {
        echo "Office name is not defined.\n";
        exit;
    }
    ...
    if ($user_cnt != $tmp_user_cnt) {
        echo "Posted user count does not equal actual user count for this office.\n";
        exit;
    }
    if ($group_cnt != $tmp_group_cnt) {
        echo "Posted group count does not equal actual group count for this office.\n";
        exit;
    }
