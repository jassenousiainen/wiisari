...
echo '
    <div class="ylalaatikko">
      <a class="otsikkolinkki" href="/timeclock/timeclock.php"><h2 class="ylaotsikko">Kellokalle</h2></a>
    </div>
    ';
...
if (isset($_SESSION['valid_user'])) {
    ...
    echo "    <td align=left valign=middle style='font-family:Tahoma;font-size:10pt;padding-left:8px;'>logged in as: $logged_in_user</td>\n";
...
echo "    <td align=right valign=middle width=10><a href='../index.php' style='font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Home&nbsp;&nbsp;</a></td>\n";
echo "    <td align=right valign=middle width=23><img src='../images/icons/bricks.png' border='0'>&nbsp;&nbsp;</td>\n";
echo "    <td align=right valign=middle width=10><a href='../login.php' style='font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Administration&nbsp;&nbsp;</a></td>\n";
echo "    <td align=right valign=middle width=23><img src='../images/icons/report.png' border='0'>&nbsp;&nbsp;</td>\n";

if ($use_reports_password == "yes") {

    echo "    <td align=right valign=middle width=10><a href='../login_reports.php' style='font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Reports&nbsp;&nbsp;</a></td>\n";

} elseif ($use_reports_password == "no") {
    echo "    <td align=right valign=middle width=10><a href='../reports/index.php' style='font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Reports&nbsp;&nbsp;</a></td>\n";
}

echo "    <td align=right valign=middle width=23><img src='../images/icons/time.png' border='0'>&nbsp;&nbsp;</td>\n";
echo "    <td align=right valign=middle width=10><a href='../punchclock/menu.php' style='font-family:Tahoma;font-size:10pt;
...
if ((isset($_SESSION['valid_user'])) || (isset($_SESSION['time_admin_valid_user'])) || (isset($_SESSION['valid_reports_user']))) {
    ...
    echo "    <td align=right valign=middle width=10><a href='../logout.php' style='font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Logout&nbsp;&nbsp;</a></td></tr>\n";
}
echo "</table>\n";
