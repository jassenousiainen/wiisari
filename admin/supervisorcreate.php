...
if  ( isset($_POST['create']) ) {
    ...
    if (!isset($_POST['displayname'])) {$error = true; $displayname = "error";}
    else {$displayname = $_POST['displayname'];}

    if (!isset($_POST['password'])) {$error = true; $password = "error";}
    else {$password = $_POST['password'];}

    if (!isset($_POST['barcode'])) {$error = true; $barcode = "error";}
    else {
    ...
    if (!isset($_POST['office_name'])) {$error = true; $office = "error";}
    else {$office = $_POST['office_name'];}

    if (!isset($_POST['group_name'])) {$error = true; $group = "error";}
    ...
    if ($error) {
        echo '<section class="container">
            ...
            <div class="box">
                <h2>Luo uusi valvoja (luonnissa tapahtui virhe!)'.$group.'</h2>
                <div class="section">
        ...
        if ($empfullname == "error") {
            echo '  <tr>
                        <p class="errortext">Käyttäjätunnus oli varattu tai tyhjä, täytäthän sen uudelleen:</p>
                    </tr>
                    <tr>
        ...
        if ($displayname == "error") {
            echo '  <tr>
                        <p class="errortext">Nimi oli tyhjä, täytäthän sen uudelleen:</p>
                    </tr>
                    <tr>
                        <td>Nimi:</td>
        ...
        if ($password == "error") {
            echo '  <tr>
                        <p class="errortext">Salasana oli tyhjä, täytäthän sen uudelleen:</p>
                    </tr>
                    <tr>
                        <td>Salasana:</td>
        ...
        if ($barcode == "error") {
            echo '  <tr>
                        <p class="errortext">Viivakoodi oli varattu tai tyhjä, täytäthän sen uudelleen:</p>
                    </tr>
                    <tr>
                        <td>Viivakoodi:</td>
        ...
        if ($office == "error") {
            echo '  <tr>
                        <p class="errortext">Et valinnut toimistoa, valitsethan sen uudelleen:</p>
                    </tr>
                    <tr>
                        <td>Toimisto:</td>
        ...
        if ($group == "error") {
            echo '  <tr>
                        <p class="errortext">Et valinnut ryhmää, valitsethan sen uudelleen:</p>
                    </tr>
                    <tr>
                        <td>Ryhmä:</td>
