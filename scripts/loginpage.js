...
window.onload=function() {
  $("#employee").click(function(){
    ...
    $(".skew-container.bottom").show("slide", { direction: "down" }, 800);
  });
  $("#employeeSlideBack").click(function(){
    ...
    $(".skew-container.bottom").hide("slide", { direction: "down" }, 800);
  });
  ...
  $("#admin").click(function(){
    ...
    $(".skew-container.top").show("slide", { direction: "up" }, 800);
  ...
  $("#adminSlideBack").click(function(){
    ...
    $(".skew-container.top").hide("slide", { direction: "up" }, 800);
  });
}
