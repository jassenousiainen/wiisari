...
echo "    <td align=right valign=middle width=10><a href='index.php' style='color:white;font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Etusivu&nbsp;&nbsp;</a></td>\n";
echo "    <td align=right valign=middle width=23><img src='images/icons/bricks.png' border='0'>&nbsp;&nbsp;</td>\n";
echo "    <td align=right valign=middle width=10><a href='login.php' style='color:white;font-family:Tahoma;font-size:10pt;text-decoration:none;'>
        Hallinta&nbsp;&nbsp;</a></td>\n";
echo "    <td align=right valign=middle width=23><img src='images/icons/report.png' border='0'>&nbsp;&nbsp;</td>\n";

if ($use_reports_password == "yes") {
    echo "    <td align=right valign=middle width=10><a href='login_reports.php' style='color:white;font-family:Tahoma;font-size:10pt;
        text-decoration:none;'>Raportit&nbsp;&nbsp;</a></td>\n";
} elseif ($use_reports_password == "no") {
    echo "    <td align=right valign=middle width=10><a href='reports/index.php' style='font-family:Tahoma;font-size:10pt;
